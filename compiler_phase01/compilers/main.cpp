...
int main() {
    ...
    nonFiniteAutomata->readREFile("/home/belal/Downloads/mazen_compilers/compilers/re.txt");
...
cout<<"3dena"<<endl;
    ...
    stb.read_input_code("/home/belal/Downloads/mazen_compilers/compilers/code.txt");
